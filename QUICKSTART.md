...
- `onelogin_update_hook_env_vars`

### Vigilance / Risk (8 tools)
...
### SCIM (9 tools)
- `onelogin_scim_get_users`
- `onelogin_scim_create_user`
- `onelogin_scim_get_user`
- `onelogin_scim_update_user`
- `onelogin_scim_patch_user`
- `onelogin_scim_delete_user`
- `onelogin_scim_get_groups`
- `onelogin_scim_create_group`
- `onelogin_scim_bulk_operations`

*...and 70+ more tools across all API domains*
...
1. **Explore Tools**: Use `tools/list` to see all 100+ available tools
2. **Read Documentation**: See [README_IMPLEMENTATION.md](README_IMPLEMENTATION.md)
3. **Check Implementation**: See [IMPLEMENTATION_SUMMARY.md](IMPLEMENTATION_SUMMARY.md)
...
The OneLogin MCP Server is now ready to use with complete API coverage across all 23 domains and 100+ tools.
